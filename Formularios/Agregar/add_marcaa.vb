Public Class add_marcaa
    Private Sub cmd_ok_Click(sender As Object, e As EventArgs) Handles cmd_ok.Click
        ...
        If edicion = True Then
            tmp.id_marca = edita_marcaa.id_marca
            If updatemarcaa(tmp) = False Then
    ...
    Private Sub Add_marcaa_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        closeandupdate(Me)
    End Sub

    Private Sub Add_marcaa_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        chk_activo.Checked = True
        If edicion = True Or borrado = True Then
            chk_secuencia.Enabled = False
            txt_marca.Text = edita_marcaa.marca
            chk_activo.Checked = edita_marcaa.activo
        End If
        ...
        If borrado = True Then
            ...
            If MsgBox("¿Está seguro que desea borrar esta marca de auto?", vbYesNo + vbQuestion) = MsgBoxResult.Yes Then
                If (borrarmarcaa(edita_marcaa)) = False Then
                    If (MsgBox("Ocurrió un error al realizar el borrado de la marca, ¿desea intectar desactivarlo para que no aparezca en la búsqueda?" _
                     , MsgBoxStyle.Question + MsgBoxStyle.YesNo)) = vbYes Then
                        ...
                        If updatemarcaa(edita_marcaa, True) = True Then
